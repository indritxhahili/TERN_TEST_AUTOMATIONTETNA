...
public class RF56OrganigrammaCantiereModificabiliLucchettoAperto_Page {
    public RF56OrganigrammaCantiereModificabiliLucchettoAperto_Page(){
    ...
    public WebElement organigramaCantiere;

    @FindBy(xpath = "//*[@id=\"cantiere\"]/div/div[2]")
    public WebElement clickDropDown;

    @FindBy(xpath = "(//span[normalize-space()='TE-ER-21-012_CN_14'])[1]")
    public WebElement click14_DropDown;
