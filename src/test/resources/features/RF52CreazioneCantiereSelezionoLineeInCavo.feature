@RF52CreazioneCantiereSelezionoLineeInCavo @Terna
Feature:Accesso con utenza PU o altre con permessi nella sezione

  Scenario:Verificare che in fase di creazione cantiere sia possibile selezionare solo l'opzione linee in cavo
