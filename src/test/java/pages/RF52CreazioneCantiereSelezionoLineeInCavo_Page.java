...
public class RF52CreazioneCantiereSelezionoLineeInCavo_Page {
    public RF52CreazioneCantiereSelezionoLineeInCavo_Page(){
    ...
    @FindBy(xpath = "//option[@value='Linee in Cavo']")
    public WebElement lineaCavo;
