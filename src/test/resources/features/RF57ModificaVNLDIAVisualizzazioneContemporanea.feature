@RF57ModificaVNLDIAVisualizzazioneContemporanea @Terna
Feature:Accesso con utenza PU o altre con permessi nella sezione
  ...
  #  Given Lutente  inserisce usernamext 3533  password M1k1am0?glce clicca sul bottone Log In
  #  Then Lutente  clicca sulpannello Project Configurator
    And Lutente  selezionaorganizzazioneSSD-RIT-REI-ARI Cagliari
